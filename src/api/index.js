...
// export const cluster_enable = adminServer + "/frontend_k8s/"+id+"/cluster_enable"
// export const cluster_disable = adminServer + "/frontend_k8s/"+id+"/cluster_disable"
// export const cluster_create = adminServer + "/frontend_k8s/"+id+"/cluster_create"
